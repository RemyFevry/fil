...
- **`docs/adr/`** — read ADRs that touch the area you're about to work in. The foundational three are ADR-0001 (steer, don't run), ADR-0002 (Flows are XState config), ADR-0003 (XState isolated behind the `FlowEngine` seam).
