...
ADR-0002 made Flows XState. Fil must not hard-lock to one library *or one language* — a license change, deprecation, or a better library could warrant swapping, including to a different runtime (e.g. `python-statemachine`, which is Python).
