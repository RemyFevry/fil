...
This Code of Conduct applies within all project spaces — GitHub issues and pull
requests on [`RemyFevry/fil`](https://github.com/RemyFevry/fil), the project's
documentation site, and any other channel officially representing the project.
